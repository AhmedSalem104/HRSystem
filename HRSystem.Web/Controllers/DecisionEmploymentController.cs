...
{
    public class DecisionEmploymentController : BaseController
    {
        #region Fields
        ...
        #region Constructors
        public DecisionEmploymentController(IDecisionEmploymentService decisionEmploymentService, IDecisionLongLegationService decisionLongLegationService, IEmployeesService employeesService, IMapper mapper)
        {
        ...
        public ActionResult Create()
        {
            ...
            var DecisionEmploymentViewModel = new DecisionEmploymentViewModel();
            DecisionEmploymentViewModel.DecisionEmploymentID = (int)_decisionEmploymentService.GetMaxDecisionEmploymentCode();

            return View(DecisionEmploymentViewModel);
        }
        [HttpPost]
        public ActionResult Create(DecisionEmploymentViewModel DecisionEmploymentViewModel)
        {
            if (ModelState.IsValid)
            {

                var Decision = _mapper.Map<DecisionEmploymentViewModel, DecisionEmployment>(DecisionEmploymentViewModel);
                _decisionEmploymentService.Insert(Decision);
            ...
            var id = _decisionEmploymentService.GetMaxId();
            Session["Id"] = id;

            DecisionEmploymentViewModel = new DecisionEmploymentViewModel();
            DecisionEmploymentViewModel.DecisionEmploymentID = (int)_decisionEmploymentService.GetMaxDecisionEmploymentCode();
            return View(DecisionEmploymentViewModel);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Session["Value"] = "Edit";
            var DecisionEmploymentViewModel = new DecisionEmploymentViewModel();
            var DriverService = _decisionEmploymentService.GetDecisionEmploymentById(id);
            DecisionEmploymentViewModel = _mapper.Map<DecisionEmployment, DecisionEmploymentViewModel>(DriverService);
            return View(DecisionEmploymentViewModel);
        }
        [HttpPost]
        public ActionResult Edit(DecisionEmploymentViewModel DecisionEmploymentViewModel)
        {
            var id = 0;

            if (ModelState.IsValid)
            {
                var driverService = _mapper.Map<DecisionEmploymentViewModel, DecisionEmployment>(DecisionEmploymentViewModel);
                _decisionEmploymentService.Update(driverService);
                id = driverService.DecisionEmploymentID;
        ...
        {
            var isDeleted = _decisionEmploymentService.Delete(id);
            return Json(new { ok = true }, JsonRequestBehavior.AllowGet);
        }

    

        public JsonResult GetDecisionEmploymentList()
        {


            var List = _decisionEmploymentService.GetAll();
        ...
        {
            var Data = _decisionEmploymentService.FixedJobRow(id);
        ...
        public ActionResult Print(int[] ids)
        {
            ...
            var vendor = _decisionEmploymentService.GetDecisionEmploymentForPrint(ids);
            List<DecisionEmploymentForPrintViewModel> mappedcarRptsList = _mapper.Map<List<DecisionEmploymentForPrintViewModel>>(vendor);
            HRSystem.Web.Reporting.Crystal.DecisionEmployment driverRpt = new HRSystem.Web.Reporting.Crystal.DecisionEmployment();
            driverRpt.Load();
