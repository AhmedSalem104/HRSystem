...
var AndroidWebapp_1 = require("../api/AndroidWebapp");
...
function default_1(scrollIntoView) {
    var alloy = (0, OuterContainer_1.default)({
        classes: [Styles_1.default.resolve('android-container')]
    });
    ...
    var dropup = Dropup.build(katamari_1.Fun.noop, scrollIntoView);
    ...
    var init = function (spec) {
        webapp.set(AndroidWebapp_1.default.produce(spec));
    };
    var exit = function () {
