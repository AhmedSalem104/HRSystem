...
namespace HRSystem.Web.Reporting.Crystal {
    ...
    public class DecisionEndStopHand : ReportClass {
        
        public DecisionEndStopHand() {
        }
        
        public override string ResourceName {
            get {
                return "DecisionEndStopHand.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "HRSystem.Web.Reporting.Crystal.DecisionEndStopHand.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDecisionEndStopHand : Component, ICachedReport {
        
        public CachedDecisionEndStopHand() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DecisionEndStopHand rpt = new DecisionEndStopHand();
            rpt.Site = this.Site;
            return rpt;
        }
